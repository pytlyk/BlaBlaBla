...
public class Database {
    ...
    public boolean userExists(String username){
        ...
        try{
            ...
            DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();//Отримує новий екземпляр ДБФ
            DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
            Document doc = dBuilder.parse(fXmlFile);
            doc.getDocumentElement().normalize();// нормалізує вигляд з хмл файлу 
            
            NodeList nList = doc.getElementsByTagName("user");
            //Превіряємо чи існує в бд такий юзер
    ...
    public void addUser(String username, String password){
        ...
        try {
            ...
            TransformerFactory transformerFactory = TransformerFactory.newInstance(); //Створюємо шаблон 
